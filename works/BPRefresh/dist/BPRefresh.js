...
(function() {
    function BPRefresh(options, cb) {
        ...
        this.resetD = "M 0 0 Q "+ this.bodyW/2 +" 0 "+ this.bodyW +" 0";
        ...
        var svgTmp = '<svg class="BPRefresh__svg-bg" preserveAspectRatio="none">\
                        <path class="BPRefresh__svg-bg__path" d="" fill="'+ options.pullBgColor +'"/>\
                    </svg>';
    ...
    BPRefresh.prototype = {
        ...
        pullchange: function(y, x) {
            ...
            this.bgPath.setAttribute("d", "M 0 0 Q "+ this.bodyW/2 +" "+ pullYCont*2 +" "+ this.bodyW +" 0");
        },
